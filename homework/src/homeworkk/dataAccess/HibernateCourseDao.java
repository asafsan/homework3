...
public class HibernateCourseDao implements CourseDao {
	...
	public void add(Course course) {
		courses.add(course);
		System.out.println("Course: " + course.getHeader() + " added to system!(Hibernate)");
		
	}
	@Override
	public void update(Course course) {
		System.out.println("Course: " + course.getHeader() + " updated!(Hibernate)");
		
	}
	@Override
	public void delete(String id) {
		System.out.println("Course removed from system!(Hibernate)");
